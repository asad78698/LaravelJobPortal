                ...
                <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <div class="card border-0 shadow mb-4">
                            <form action="{{ route('account.updateprofie') }}" id="userForm" name="userForm">
                                @method('PUT')
                                <div class="card-body  p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="designation" id="designation" type="text" placeholder="Designation"
                                            class="form-control">
                                    </div>
                                    <div class="mb-4">
                        ...
                        <div class="card border-0 shadow mb-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="oldpassword " id="oldpassword" type="password" placeholder="Old Password"
                                        class="form-control">
                                </div>
                                <div class="mb-4">
...
@section('customjs')
    <script>
        ...
        $("#userForm").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('account.updateprofie') }}", 
                type: "PUT",
                dataType: "json",
