                        ...
                        <form action="" method="POST" id="editjobform" name="editjobform">
                            <div class="card border-0 shadow mb-4 ">
                                <div class="card-body card-form p-4">
                                    <h3 class="fs-4 mb-1">Eid Job Details</h3>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                            ...
                                            <select name="jobtype" id="jobtype" class="form-control">
                                                ...
                                                @if ($jobtypes->isNotEmpty())
                                                    @foreach ($jobtypes as $jobtype)
                                                        <option {{ $job->jobtypes_id == $jobtype->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-6  mb-4">
                                            <label for="" class="mb-2">Vacancy<span
                                                    class="req">*</span></label>
                                            <input value="{{ $job->vacancies }}" type="number" min="1"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-4 col-md-6">
                                            <label for="" class="mb-2">Location<span
                                                    class="req">*</span></label>
                                            <input value="{{ $job->location ? '$job->location' : 'Islamabad' }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="responsibility" id="responsibility" cols="5" rows="5"
                                            placeholder="Responsibility">{{ $job->responsibilies }}</textarea>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="experience" id="experience" class="form-control">
                                            ...
                                            <option value="11"{{ $job->experience == 11 ? 'selected' : '' }}>11 Year
                                            </option>
                                            <option value="12"{{ $job->experience == '12+' ? 'selected' : '' }}>12+
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-4 col-md-6">
                                            <label for="" class="mb-2">Name<span
                                                    class="req">*</span></label>
                                            <input value="{{ $job->companyname }}" type="text"
                                        ...
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <input value="{{ $job->companylocation }}" type="text"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input value="{{ $job->companywebsite }}" type="text" placeholder="Website"
...
@section('editjobform')
    <script>
        $("#editjobform").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('account.updade.job', $job->id) }}",
                type: "POST",
                dataType: "json",
                    ...
                    if (response.status === true) {
                        ...
                        if (errors.title) {
                            $('#title').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.title[0]);
                        } else {
                        ...
                        if (errors.category) {
                            $('#category').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.category[0]);
                        } else {
                            $('#category').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (errors.jobtype) {
                            $('#jobtype').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.jobtype[0]);
                        } else {
                            $('#jobtype').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (errors.vacancy) {
                            $('#vacancy').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.vacancy[0]);
                        } else {
                            $('#vacancy').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (errors.location) {
                            $('#location').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.location[0]);
                        } else {
                            $('#location').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (errors.description) {
                            $('#description').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.description[0]);
                        } else {
                            $('#description').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (errors.company_name) {
                            $('#company_name').addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(errors.company_name[0]);
                        } else {
                            $('#company_name').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
