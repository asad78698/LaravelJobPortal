                ...
                <div class="row">
                    ...
                    <div class=" col-md-3 mb-xs-3 mb-sm-3 mb-lg-0">
                        <div class="d-grid gap-2">
                            <a name="searchjob" id="searchjob" href="#" class="btn btn-primary btn-block">Search</a>
                        </div>
                ...
                @if ($categories->isNotEmpty())
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-6">
                        <div class="single_catagory">
                            ...
                            {{-- <p class="mb-0"> <span>Vacancies </span>0</p> --}}
                        </div>
                    </div>
                    @endforeach
                @endif
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="bg-light p-3 border">
                                            <p class="mb-0">
                                                <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                                <span class="ps-1">{{Str::words($LatestJob->location)}}</span>
                                            </p>
                                            <p class="mb-0">
                                                <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
...
<script>
    $('#searchjob').click(function(e){
        ...
        var url = "{{ route('jobs') }}?&keyword="+keyword+"&location="+location+"&category="+category;
